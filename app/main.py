...
@app.get('/antenas')
def list_antenas(provincia: str = None, municipio: str = None, operador: str = None, tecnologia: str = None, page: int = 1, limit: int = 100):
filtered = ANTENAS
if provincia:
...
def antenas_near(lat: float = Query(...), lon: float = Query(...), radio_m: int = Query(5000), limit: int = Query(50)):
def distance(a):
R = 6371000
